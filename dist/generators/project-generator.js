...
import { TemplateGenerator } from "./plop-generator.js";
const execAsync = promisify(exec);
export async function generateProject(config) {
    const { projectName, description, templateType, walletProvider, contractFramework, projectPath, installDependencies, spinner, miniappName, miniappDescription, miniappTags, miniappTagline, } = config;
    ...
    if (installDependencies) {
        ...
        try {
            ...
            console.log(chalk.yellow("You can install them manually later with: pnpm install"));
