...
import { Shield, Users, Sprout, ArrowLeft } from 'lucide-react';
    ...
    <main className="min-h-screen bg-gradient-to-br from-[#100720] via-[#31087B] to-[#100720]">
      ...
      <header className="p-6 flex justify-between items-center border-b border-[#FA2FB5]/20">
        <div className="flex items-center gap-4">
          <button
            onClick={() => router.push('/')}
            className="flex items-center gap-2 px-4 py-2 rounded-lg text-gray-300 hover:text-white hover:bg-white/10 transition-all border-2 border-[#FA2FB5]/30 hover:border-[#FA2FB5]"
          >
